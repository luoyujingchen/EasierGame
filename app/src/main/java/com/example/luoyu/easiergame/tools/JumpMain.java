...
public class JumpMain {
	...
	public static void main(String[] args) {
		int lastDistance = 0;
		while(true) {
			String command = "cmd /c C:\\Users\\luoyu\\Desktop\\screenshot.bat";
			try {
	        ...
	        int distance = getDistance("C:/Users/luoyu/Desktop/screenshot.png");
...
//	        HttpClientUtil.invokeGet("http://192.168.11.2/jfinal_pi/gpioRelay/" + delayMs, null, "utf-8", 2000, 2000);
	...
	public static int getDistance(String imgPath) {
		...
		try {
			bufferedImage = BitmapFactory.decodeFile(imgPath);
		}catch (Exception e){
            throw e;
        }
        //自动模式的魔数也改为自动计算
        ...
        if (secondPoint == null || secondPoint.x == 0 || distance < 75 ||
